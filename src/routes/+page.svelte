<script lang="ts">
	import { ArrowRight, Pencil, BookmarkCheck, GraduationCap, PlayCircle } from 'lucide-svelte';
...
<div class="flex flex-col items-center mt-6 sm:mt-10 mb-56">
	<div class="w-full max-w-5xl mx-auto px-4 sm:px-12">
			...
			<div in:fade={{ duration: 1000 }}>
				<div class="space-y-5 max-w-3xl">
					...
					<p class="text-base-content/90 text-xl sm:text-2xl">
						Your class‑to‑boards study engine - helping you master today’s material while building
						tomorrow’s board‑prep bank.
					</p>
				</div>

				<div
					class="flex flex-col sm:flex-row gap-3 sm:gap-4 my-8"
		...
		<section
			class="mt-16 sm:mt-24 px-4 sm:px-0"
			aria-labelledby="features-title"
			in:fade={{ duration: 900 }}
		>
			<h2 id="features-title" class="font-bold text-4xl sm:text-5xl">
				Learn faster today. Bank your prep for tomorrow.
			</h2>
			<p class="text-lg sm:text-xl mt-4 text-base-content/80">
				A focused workflow that compounds your learning - without extra effort.
			</p>
			<div class="mt-12">
				<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
					<div
						class="group flex flex-col rounded-2xl border border-base-200/70 bg-base-100/60 backdrop-blur-sm p-6 lg:p-7 transition hover:-translate-y-0.5 hover:shadow-sm"
					...
					>
						...
						<p class="mt-2 text-base leading-relaxed text-base-content/80">
							Write your own questions or use AI to generate them. Tag by lesson and quiz as you go.
						</p>
					</div>
					<div
						class="group flex flex-col rounded-2xl border border-base-200/70 bg-base-100/60 backdrop-blur-sm p-6 lg:p-7 transition hover:-translate-y-0.5 hover:shadow-sm"
						in:fade={{ duration: 700, delay: 180 }}
					>
						<div class="relative inline-flex items-center w-fit">
							<BookmarkCheck
								size="28"
						...
						<p class="mt-2 text-base leading-relaxed text-base-content/80">
							Star, flag, and eliminate options. Focus where it counts with spaced review.
						</p>
					</div>
					<div
						class="group flex flex-col rounded-2xl border border-base-200/70 bg-base-100/60 backdrop-blur-sm p-6 lg:p-7 transition hover:-translate-y-0.5 hover:shadow-sm"
						in:fade={{ duration: 700, delay: 260 }}
					>
						<div class="relative inline-flex items-center w-fit">
							<GraduationCap
								size="28"
						...
						<p class="mt-2 text-base leading-relaxed text-base-content/80">
							Every quiz builds your personalized board‑prep Q‑bank—ready when you are.
						</p>
					</div>
				</div>
			</div>
		...
		<section
			class="mt-16 lg:mt-28 flex flex-col lg:flex-row gap-y-10 gap-x-8 lg:gap-x-24"
		...
		>
			...
			>
				...
				<p class="text-lg sm:text-xl mt-4">
					Purpose‑built tools that make mastering complex topics faster. From first exposure to
					confident recall.
				</p>
			</div>
