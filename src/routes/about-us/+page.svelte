	...
	<script type="application/ld+json">
		{
			...
			"mainEntity": {
				"@type": "Organization",
				"name": "LearnTerms",
				"url": "https://learnterms.com"
			}
		}
	</script>
</svelte:head>

<main id="main-content" class="mx-auto max-w-5xl px-8 py-12">
	<header class="mb-8">
	...
	<div class="prose max-w-none mt-6 prose-lg">
		...
		<figure class="my-12 mx-12">
			<img
				...
				class="w-full rounded-xl shadow-md ring-1 ring-base-content/10"
				loading="lazy"
				decoding="async"
			/>
			<figcaption class="text-sm text-base-content/70 mt-3 text-center">
		...
		<p class="text-sm text-base-content/60 mt-2">
			Last updated <time datetime="2025-08-09">August 9, 2025</time>.
			<a class="link" href="#main-content">Back to top</a>
		</p>
	</div>
</main>
