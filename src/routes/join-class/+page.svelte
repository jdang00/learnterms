					...
					<div class="avatar">
						<div
							class="ring-primary ring-offset-base-100 {showConfirmation
								? 'w-16'
								: 'w-32'} rounded-full ring-3 ring-offset-2 transition-all duration-300"
						>
					...
					<div class="avatar avatar-placeholder">
						<div
							class="bg-secondary text-neutral-content {showConfirmation
								? 'w-16'
								: 'w-32'} rounded-full ing-primary ring-offset-base-100 ring-3 ring-offset-2 transition-all duration-300"
						>
					...
					<div class="card-body p-8">
						<div class="text-center mb-6">
							<div class="flex justify-center mb-4">
								<div class="avatar">
									<div
										class="ring-success ring-offset-base-100 w-20 rounded-full ring-3 ring-offset-2"
									>
