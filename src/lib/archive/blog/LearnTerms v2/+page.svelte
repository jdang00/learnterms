	...
	<div class="mx-auto w-full max-w-3xl px-6">
		...
		<header class="mb-16">
			...
			<div class="mt-10 flex items-center gap-6">
				<a href="https://www.justindang.dev/" target="_blank">
					<div class="avatar">
						<div class="ring-primary ring-offset-base-100 w-16 rounded-full ring-3 ring-offset-2">
							<img
		...
		<div class="space-y-20">
			...
			<section>
				...
				<!-- Performance Card -->
				<div class="my-14 rounded-xl border-2 border-base-content/20 bg-base-200/30 p-10 shadow-xs">
