...
<div class="flex flex-col items-center p-4 w-full">
	...
	{#if showAnswerPanel}
		<div
			class="card bg-base-100 w-72 sm:w-80 shadow-md mt-6 border border-base-content/10 rounded-2xl"
		>
			<div class="card-body">
				<h3 class="text-lg font-semibold mb-2 {qs.showSolution ? '' : 'blur-xs'}">
					{displayAnswer()}
				</h3>
