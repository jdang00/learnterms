...
>
	<a class="btn btn-ghost btn-sm flex-shrink-0 flex items-center" href={`/classes?classId=${classId}`}>
		<ArrowLeft />
	</a>
	<div
	...
	>
		...
		<h1 class="font-bold text-sm sm:text-base truncate">{module.data.title}</h1>
	</div>
