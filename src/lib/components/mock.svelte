...
<div class="hidden lg:block size-2/5 lg:border-r border-base-300">
	...
	<div class="mx-8 mt-4">
		...
		<p class="text-base-content mt-2">
			Anti-infective medications, including antibiotics, antifungals, antivirals, and
			antiparasitics.
		</p>
	...
	<div class="mb-8 mt-2 w-full">
			...
			<div class="flex flex-row justify-between mb-4">
				<div class="flex flex-row flex-wrap items-end">
					...
					<span class="text-base-content/70 font-medium text-xs ms-2 mb-1 sm:mt-0"
						>Pick {question.correctAnswers.length}.</span
					>
				</div>
			</div>
		...
		<div class="flex flex-row justify-center mt-6 gap-3">
			...
			<div class="relative inline-block">
				<button class="btn btn-xs sm:btn-sm btn-success btn-soft" onclick={handleCheck}
					>Check</button
				>
			...
			<button
				class="btn btn-xs sm:btn-sm {flagged ? 'btn-warning' : 'btn-warning btn-soft'}"
				onclick={handleFlag}
