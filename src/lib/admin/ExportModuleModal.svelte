...
<dialog class="modal" class:modal-open={isOpen}>
	<div class="modal-box rounded-2xl">
		...
		<p class="text-sm text-base-content/70 mb-6">
			Exporting content for <span class="font-semibold">{moduleItem?.title}</span>. Choose a format
			below.
		</p>
		...
		<div class="grid grid-cols-1 gap-3">
			...
			>
				<div
					class="bg-base-200 p-2 rounded-xl group-hover:bg-primary-content/20 text-base-content group-hover:text-primary-content transition-colors"
				>
					<FileText size={24} />
				</div>
			...
			>
				<div
					class="bg-base-200 p-2 rounded-xl group-hover:bg-secondary-content/20 text-base-content group-hover:text-secondary-content transition-colors"
				>
					<FileJson size={24} />
				</div>
				<div class="text-left ml-2 flex-1">
			...
			>
				<div
					class="bg-base-200 p-2 rounded-xl group-hover:bg-accent-content/20 text-base-content group-hover:text-accent-content transition-colors"
				>
